...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_listtetano"][2]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_listtetano"][3]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_listtetano"][4]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_listhepa"][0]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_listhepa"][1]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_listhepa"][2]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_list_hepab"][0]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_list_hepab"][1]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_list_hepab"][2]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_list_influenza"][0]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_list_fiebre"][0]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_list_sarampion"][0]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    fecha_value = data["dosis_list_sarampion"][1]["fecha"]
except IndexError:
    fecha_value = ''
pdf.cell(w=18, h=5, txt=fecha_value, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    esquema_value = data["dosis_listtetano"][0]["esquema"]
...
# Manejar la posibilidad de IndexError o KeyError
try:
    esquema_value = data["dosis_listtetano"][2]["esquema"]
except (IndexError, KeyError):
    esquema_value = ''
# Verificar si esquema_value es True o 'True' y establecer la casilla en consecuencia
if esquema_value in (True, 'True'):
...
# Manejar la posibilidad de IndexError o KeyError
try:
    esquema_value = data["dosis_listtetano"][3]["esquema"]
except (IndexError, KeyError):
    esquema_value = ''
# Verificar si esquema_value es True o 'True' y establecer la casilla en consecuencia
if esquema_value in (True, 'True'):
...
# Manejar la posibilidad de IndexError o KeyError
try:
    esquema_value = data["dosis_listtetano"][4]["esquema"]
except (IndexError, KeyError):
    esquema_value = ''
# Verificar si esquema_value es True o 'True' y establecer la casilla en consecuencia
if esquema_value in (True, 'True'):
...
# Manejar la posibilidad de IndexError o KeyError
try:
    esquema_value = data["dosis_listhepa"][0]["esquema"]
except (IndexError, KeyError):
    esquema_value = ''
# Verificar si esquema_value es True o 'True' y establecer la casilla en consecuencia
if esquema_value in (True, 'True'):
...
# Manejar la posibilidad de IndexError o KeyError
try:
    esquema_value = data["dosis_listhepa"][1]["esquema"]
except (IndexError, KeyError):
    esquema_value = ''
# Verificar si esquema_value es True o 'True' y establecer la casilla en consecuencia
if esquema_value in (True, 'True'):
...
# Manejar la posibilidad de IndexError o KeyError
try:
    esquema_value = data["dosis_listhepa"][2]["esquema"]
except (IndexError, KeyError):
    esquema_value = ''
# Verificar si esquema_value es True o 'True' y establecer la casilla en consecuencia
if esquema_value in (True, 'True'):
...
# Manejar la posibilidad de IndexError o KeyError
try:
    esquema_value = data["dosis_list_hepab"][0]["esquema"]
except (IndexError, KeyError):
    esquema_value = ''
# Verificar si esquema_value es True o 'True' y establecer la casilla en consecuencia
if esquema_value in (True, 'True'):
...
# Manejar la posibilidad de IndexError o KeyError
try:
    esquema_value = data["dosis_list_hepab"][1]["esquema"]
except (IndexError, KeyError):
    esquema_value = ''
# Verificar si esquema_value es True o 'True' y establecer la casilla en consecuencia
if esquema_value in (True, 'True'):
...
# Manejar la posibilidad de IndexError o KeyError
try:
    esquema_value = data["dosis_list_hepab"][2]["esquema"]
except (IndexError, KeyError):
    esquema_value = ''
# Verificar si esquema_value es True o 'True' y establecer la casilla en consecuencia
if esquema_value in (True, 'True'):
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    esquema_value = data["dosis_list_influenza"][0]["esquema"]
except (IndexError, KeyError):
    esquema_value = ''
if data.get("dosis_list_influenza") and \
   (data["dosis_list_influenza"][0]["esquema"] is True or data["dosis_list_influenza"][0]["esquema"] == 'True'):
    pdf.cell(w=24, h=5, txt='x', border=1, ln=2, align='C', fill=1)  # Segunda casilla con 'x'
else:
    pdf.cell(w=24, h=5, txt='', border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    esquema_value = data["dosis_list_fiebre"][0]["esquema"]
except (IndexError, KeyError):
    esquema_value = ''
if data.get("dosis_list_fiebre") and \
   (data["dosis_list_fiebre"][0]["esquema"] is True or data["dosis_list_fiebre"][0]["esquema"] == 'True'):
    pdf.cell(w=24, h=5, txt='x', border=1, ln=2, align='C', fill=1)  # Segunda casilla con 'x'
else:
    pdf.cell(w=24, h=5, txt='', border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    esquema_value = data["dosis_list_sarampion"][0]["esquema"]
except (IndexError, KeyError):
    esquema_value = ''
if data.get("dosis_list_sarampion") and \
   (data["dosis_list_sarampion"][0]["esquema"] is True or data["dosis_list_sarampion"][0]["esquema"] == 'True'):
    pdf.cell(w=24, h=5, txt='x', border=1, ln=2, align='C', fill=1)  # Segunda casilla con 'x'
else:
    pdf.cell(w=24, h=5, txt='', border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    esquema_value = data["dosis_list_sarampion"][1]["esquema"]
    if len(data.get("dosis_list_sarampion", [])) >= 2 and \
       (esquema_value is True or esquema_value == 'True'):
        pdf.cell(w=24, h=5, txt='x', border=1, ln=2, align='C', fill=1)  # Segunda casilla con 'x'
    else:
        pdf.cell(w=24, h=5, txt='', border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
except (IndexError, KeyError):
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_listtetano"][2]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_listtetano"][3]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_listtetano"][4]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_listhepa"][0]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_listhepa"][1]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_listhepa"][2]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_list_hepab"][0]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_list_hepab"][1]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_list_hepab"][2]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_list_influenza"][0]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_list_fiebre"][0]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_list_sarampion"][0]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    responsable = data["dosis_list_sarampion"][1]["responsable"]
except IndexError:
    responsable = ''
pdf.cell(w=28, h=5, txt=responsable, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_listtetano"][2]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_listtetano"][3]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_listtetano"][4]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_listhepa"][0]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_listhepa"][1]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_listhepa"][2]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_list_hepab"][0]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_list_hepab"][1]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_list_hepab"][2]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_list_influenza"][0]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_list_fiebre"][0]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_list_sarampion"][0]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    establecimiento = data["dosis_list_sarampion"][1]["establecimiento"]
except IndexError:
    establecimiento = ''
pdf.cell(w=28, h=5, txt=establecimiento, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_listtetano"][2]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_listtetano"][3]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_listtetano"][4]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_listhepa"][0]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_listhepa"][1]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_listhepa"][2]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_list_hepab"][0]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_list_hepab"][1]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_list_hepab"][2]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_list_influenza"][0]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_list_fiebre"][0]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_list_sarampion"][0]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
...
pdf.set_fill_color(255, 255, 255)  # Establecer el color de fondo en blanco
try:
    observaciones = data["dosis_list_sarampion"][1]["observaciones"]
except IndexError:
    observaciones = ''
pdf.cell(w=45, h=5, txt=observaciones, border=1, ln=2, align='C', fill=1)  # Segunda casilla de texto en blanco
tfont(pdf, '')
